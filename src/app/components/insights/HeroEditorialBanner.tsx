  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ fontSize: 9 }}>{CRITICALITY.icon}</span>
          <span style={{ fontSize: 8, fontWeight: 700, color: CRITICALITY.color, letterSpacing: "0.08em" }}>
            CRITICITÉ {CRITICALITY.level}
          </span>
        </div>
        <span style={{ fontSize: 8.5, color: C.muted }}>Cette analyse affecte directement les actifs UEMOA suivants :</span>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4, marginLeft: "auto" }}>
          ...
          <span style={{ fontSize: 8, color: C.gold, fontWeight: 600 }}>
      ...
      >
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 8, maxWidth: 580 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 4, marginLeft: 4 }}>
              ...
              <span style={{ fontSize: 9, color: C.muted }}>Il y a 2h · Mer 08 Avr 2026</span>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 2 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <div>
                <div style={{ fontSize: 10, fontWeight: 700, color: C.text }}>Moussa Ouédraogo</div>
                <div style={{ fontSize: 7.5, color: C.muted }}>Chef Économiste · Bloomfield Intelligence</div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
              ...
              <span style={{ fontSize: 8.5, color: C.accent, fontWeight: 600 }}>1 247 lectures · ~8 min</span>
            </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 6, minWidth: 210 }}>
          ...
          {MARKET_IMPACTS.map((imp) => {
            ...
            return (
              ...
              >
                ...
                <span style={{ fontSize: 8.5, color: C.dim, fontWeight: 600 }}>{imp.label}</span>
              </div>
            );
          })}
          ...
          >
            ...
            <span style={{ fontSize: 8.5, color: C.gold, fontWeight: 600 }}>Intelligence Propriétaire Bloomfield</span>
          </div>
        </div>
      </div>
    </div>
